                               ...
                               const VideoRenderType videoRenderType/*=kRenderDefault*/)
{
    ...
    printf("Creating video renderer");
#ifdef WEBRTC_INCLUDE_INTERNAL_VIDEO_RENDER
    printf("It's the internal renderer");
#else
    printf("It' the external renderer");
#endif
    ...
    _ptrWindow(window), _fullScreen(fullscreen), _ptrRenderer(NULL)
{
    ...
    switch (videoRenderType)
    {
        ...
        case kRenderiOS:
        {
            printf("ModuleVideoRenderImpl::ModuleVideoRenderImpl - Creating iOS rendering module");
        ...
        case kRenderExternal:
        {
            ...
            printf("ModuleVideoRenderImpl::ModuleVideoRenderImpl - Creating external rendering module");
    ...
    if (_ptrRenderer)
    {
        ...
        {
            printf("Failed to init render module");
        } else {
            printf("Successfully init'd render module");
        }
    }
}
...
int32_t ModuleVideoRenderImpl::AddExternalRenderCallback(
    ...
    printf("Attempting to add external renderer");
