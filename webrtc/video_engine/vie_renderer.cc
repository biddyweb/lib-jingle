...
//    printf("Should deliver frame");
    assert(render_callback_ != NULL);
...
//    printf("Setting the external renderer");
//    assert(false);
...
//    printf("Render frame in ViEExternalRendererImpl");
...
//        printf("In todo empty else");
    }
    return 0;
  }

//    printf("Setting up out_frame");
...
//    printf("Do we have an out frame?");
    
  if (out_frame) {
      
//      printf("We do, deliver frame");
